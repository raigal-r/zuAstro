...
export const IS_PROD = process.env.NODE_ENV === "production" && process.env.STAGE !== "staging";
export const IS_STAGING = process.env.NODE_ENV === "production" && process.env.STAGE === "staging";
