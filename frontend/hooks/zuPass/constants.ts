...
export const IS_PROD = process.env.NODE_ENV === "production" && process.env.STAGING !== "true";
export const IS_STAGING = process.env.NODE_ENV === "production" && process.env.STAGING === "true";
